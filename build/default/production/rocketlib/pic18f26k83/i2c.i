...
# 2 "rocketlib/pic18f26k83/i2c.c" 2
...
# 4 "rocketlib/pic18f26k83/i2c.c" 2
...
static _Bool i2c_write(uint8_t address, const uint8_t *data, uint8_t len) {
...
static _Bool i2c_read(uint8_t address, uint8_t *data, uint8_t len) {
