...
# 2 "<built-in>" 2
# 1 "rocketlib/pic18f26k83/pwm.c" 2
# 1 "rocketlib/include/pwm.h" 1



# 1 "rocketlib/include/common.h" 1
...
# 2 "rocketlib/pic18f26k83/pwm.c" 2
...
# 3 "rocketlib/pic18f26k83/pwm.c" 2
...
static w_status_t configure_pps(uint8_t ccp_module, pwm_pin_config_t pin_config) {
    ...
    (TRISpin_config.portA &= ~(1 << (pin_config.pin)));



    (*Rpin_config.portpin_config.pinPPS = (ccp_module));
...
w_status_t pwm_init(uint8_t ccp_module, pwm_pin_config_t pin_config, uint16_t pwm_period) {
    ...
    volatile uint8_t *ccp_con = &CCPccp_moduleCON;
    *ccp_con = 0x8C;
...
w_status_t pwm_update_duty_cycle(uint8_t ccp_module, uint16_t duty_cycle) {
    ...
    CCPRccp_moduleL = duty_cycle & 0xFF;



    CCPRccp_moduleH = (duty_cycle >> 8) & 0x03;
