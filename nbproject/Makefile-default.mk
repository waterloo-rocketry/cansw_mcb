...
${OBJECTDIR}/rocketlib/pic18f26k83/pwm.p1: rocketlib/pic18f26k83/pwm.c  nbproject/Makefile-${CND_CONF}.mk 
	@${MKDIR} "${OBJECTDIR}/rocketlib/pic18f26k83" 
	@${RM} ${OBJECTDIR}/rocketlib/pic18f26k83/pwm.p1.d 
	@${RM} ${OBJECTDIR}/rocketlib/pic18f26k83/pwm.p1 
	${MP_CC} $(MP_EXTRA_CC_PRE) -mcpu=$(MP_PROCESSOR_OPTION) -c  -D__DEBUG=1  -mdebugger=pickit5   -mdfp="${DFP_DIR}/xc8"  -fno-short-double -fno-short-float -memi=wordwrite -O0 -fasmfile -maddrqual=ignore -DBOARD_TYPE_UNIQUE_ID=BOARD_TYPE_ID_CANARD_MOTOR -DBOARD_INST_UNIQUE_ID=0x02 -D_XTAL_FREQ=12000000 -xassembler-with-cpp -I"canlib" -I"rocketlib/include" -I"canlib/pic18f26k83" -I"canlib/message" -I"canlib/util" -v -mwarn=-3 -Wa,-a -DXPRJ_default=$(CND_CONF)  -msummary=-psect,-class,+mem,-hex,-file  -ginhx32 -Wl,--data-init -mno-keep-startup -mno-download -mno-default-config-bits $(COMPARISON_BUILD)  -std=c99 -gdwarf-3 -mstack=compiled:auto:auto:auto     -o ${OBJECTDIR}/rocketlib/pic18f26k83/pwm.p1 rocketlib/pic18f26k83/pwm.c 
	@-${MV} ${OBJECTDIR}/rocketlib/pic18f26k83/pwm.d ${OBJECTDIR}/rocketlib/pic18f26k83/pwm.p1.d 
	@${FIXDEPS} ${OBJECTDIR}/rocketlib/pic18f26k83/pwm.p1.d $(SILENT) -rsi ${MP_CC_DIR}../  
	
${OBJECTDIR}/mypwm.p1: mypwm.c  nbproject/Makefile-${CND_CONF}.mk 
	@${MKDIR} "${OBJECTDIR}" 
	@${RM} ${OBJECTDIR}/mypwm.p1.d 
	@${RM} ${OBJECTDIR}/mypwm.p1 
	${MP_CC} $(MP_EXTRA_CC_PRE) -mcpu=$(MP_PROCESSOR_OPTION) -c  -D__DEBUG=1  -mdebugger=pickit5   -mdfp="${DFP_DIR}/xc8"  -fno-short-double -fno-short-float -memi=wordwrite -O0 -fasmfile -maddrqual=ignore -DBOARD_TYPE_UNIQUE_ID=BOARD_TYPE_ID_CANARD_MOTOR -DBOARD_INST_UNIQUE_ID=0x02 -D_XTAL_FREQ=12000000 -xassembler-with-cpp -I"canlib" -I"rocketlib/include" -I"canlib/pic18f26k83" -I"canlib/message" -I"canlib/util" -v -mwarn=-3 -Wa,-a -DXPRJ_default=$(CND_CONF)  -msummary=-psect,-class,+mem,-hex,-file  -ginhx32 -Wl,--data-init -mno-keep-startup -mno-download -mno-default-config-bits $(COMPARISON_BUILD)  -std=c99 -gdwarf-3 -mstack=compiled:auto:auto:auto     -o ${OBJECTDIR}/mypwm.p1 mypwm.c 
