...
void updatePulseWidth(uint16_t angle) {
    float normalized_angle = (float) angle - (32768 - MAX_CANARD_ANGLE_MDEG); //convert 32768 +- 10000 to 0-20000
    float pulse_width_us = MOTOR_MIN_PULSE_WIDTH_US + (normalized_angle * (MOTOR_MAX_PULSE_WIDTH_US - MOTOR_MIN_PULSE_WIDTH_US)) / (MAX_CANARD_ANGLE_MDEG * 2);
